...
#echo $@
slcioFilesTextFile="${1}"
gearFile="${2}"
outputPath="${3}"
pandoraSettingsFile="${4}"
...
ECalBarrelTimeWindowMax="${7}"
HCalBarrelTimeWindowMax="${8}"
ECalEndCapTimeWindowMax="${9}"
...
cd ${XmlGeneration}
python PrepareXml.py "Muon" ${muonEnergyCalibration} ${slcioFilesTextFile} ${gearFile} ${pandoraSettingsFile} ${CalibrECAL} ${CalibrHCALBarrel} ${CalibrHCALEndCap} ${CalibrHCALOther} ${ECalBarrelTimeWindowMax} ${HCalBarrelTimeWindowMax} ${ECalEndCapTimeWindowMax} ${HCalEndCapTimeWindowMax} ${ECalGeVToMIP} ${HCalGeVToMIP} ${MuonGeVToMIP} ${ECalMIPMPV} ${HCalMIPMPV} ${MHHHE} ${ECalToEm} ${HCalToEm} ${ECalToHad} ${HCalToHad}
...
cd ${XmlGeneration}
python PrepareXml.py "KaonL" ${kaonLEnergyCalibration} ${slcioFilesTextFile} ${gearFile} ${pandoraSettingsFile} ${CalibrECAL} ${CalibrHCALBarrel} ${CalibrHCALEndCap} ${CalibrHCALOther} ${ECalBarrelTimeWindowMax} ${HCalBarrelTimeWindowMax} ${ECalEndCapTimeWindowMax} ${HCalEndCapTimeWindowMax} ${ECalGeVToMIP} ${HCalGeVToMIP} ${MuonGeVToMIP} ${ECalMIPMPV} ${HCalMIPMPV} ${MHHHE} ${ECalToEm} ${HCalToEm} ${ECalToHad} ${HCalToHad}
